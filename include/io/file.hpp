...
inline core::io_read read(int fd, std::span<char> buffer, core::cancel_token &token, uint64_t offset = -1ULL) noexcept {
...
inline core::io_write write(int fd, std::span<const char> buffer, core::cancel_token &token, uint64_t offset = -1ULL) noexcept {
...
inline core::io_openat openat(int directory_fd, const char *path, int flags, core::cancel_token &token, mode_t mode = 0) noexcept {
...
inline core::io_fsync fsync(int fd, core::cancel_token &token, unsigned flags = 0) noexcept { return core::io_fsync{fd, flags, &token}; }
...
inline core::io_statx statx(int directory_fd, const char *path, int flags, unsigned mask, struct statx *result, core::cancel_token &token) noexcept {
...
inline core::io_fallocate fallocate(int fd, int mode, uint64_t offset, uint64_t length, core::cancel_token &token) noexcept {
...
inline core::io_unlinkat unlinkat(int directory_fd, const char *path, core::cancel_token &token, int flags = 0) noexcept {
...
inline core::io_renameat renameat(int old_directory_fd, const char *old_path, int new_directory_fd, const char *new_path, core::cancel_token &token,
                                  unsigned flags = 0) noexcept {
...
inline core::io_mkdirat mkdirat(int directory_fd, const char *path, mode_t mode, core::cancel_token &token) noexcept {
