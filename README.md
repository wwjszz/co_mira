...
The complete HTTP server is in
[`example/http_server/main.cc`](example/http_server/main.cc).
...
![HTTP throughput](benchmark/http_server/results-server-2cpu/throughput.svg)
...
summaries, methodology and additional WSL results are in
[`benchmark/http_server`](benchmark/http_server/README.md).
